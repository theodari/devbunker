...
const TIPS = [
  ...
  "DevBunker runs locally — no API keys needed. The AI model starts automatically.",
  ...
  "Create {highlight}devbunker.json{/highlight} for project settings and {highlight}tui.json{/highlight} for TUI settings",
  "Place TUI settings in {highlight}~/.config/devbunker/tui.json{/highlight} for global config",
