...
// DevBunker: Only local/OpenAI-compatible providers are supported
import { createOpenAICompatible } from "@ai-sdk/openai-compatible"
import type { LanguageModelV2 } from "ai"
// DevBunker: Cloud provider imports removed
...
export namespace Provider {
  ...
  // DevBunker: Only OpenAI-compatible provider for local LLM backends
  ...
  // DevBunker: All cloud custom loaders removed. Only local providers supported.
  ...
  async function getSDK(model: Model) {
    try {
      ...
      // DevBunker: All providers use openai-compatible
  ...
  export async function getSmallModel(providerID: string) {
    ...
    // DevBunker: Use first available model from configured local provider
